...
import { START_YEAR, NUM_OF_YEARS, NUM_OF_TRACKS } from '../constants/constants'

import { buildTimebar, buildTrack } from '../../utils/builders'

import { fill } from '../../utils/tasbsListsUtils'
...
class TabsLists extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    const {tabsByTime} = this.props;
    return (
      <div className="app">
        <h1 className="title">React Timelines</h1>
        <p>Tabs time = {tabsByTime}</p>
